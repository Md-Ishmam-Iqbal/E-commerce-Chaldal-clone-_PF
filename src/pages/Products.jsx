              ...
              <div>
                <div className="catalogBrowser">
                  <div className="loaded">
                    ...
                    <section className="bodyWrapperProducts">
